<template>
  <div
    ...
    :style="`background-size: 120px 120px; background-image: linear-gradient(to right, ${colorMode === 'light' ? '#e5e7eb' : '#27272a'} 2px, transparent 2px), linear-gradient(to bottom, ${colorMode === 'light' ? '#e5e7eb' : '#27272a'} 2px, transparent 2px);`"
  >
    <div class="mb-4 flex">
      ...
      <span
        ...
        class="ml-2 self-center text-[2.5rem] font-bold"
